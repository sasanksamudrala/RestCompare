...
public class SearchResourceIntegrationTest {
   ...
   /* @Test
    public void testIdLeft_SecondTimeForUpdate() throws JSONException, JsonMappingException, JsonParseException, IOException {
        JSONObject jsonObj = new JSONObject().put("encodedValue","MTAxMDEw");
        ObjectMapper mapper = new ObjectMapper();
        SearchRequest searchRequest = mapper.readValue(jsonObj.toString(), SearchRequest.class);  
        ...
        given().when().get("1/all").then()
    	.statusCode(200)
    	.body("content.encodedString", hasItem("MTAxMDEw"))
    	;
    }*/
   ...
   /* @Test
    ...
    @Test
    public void testIdAll() {
        given().when().get(1+"/all").then().statusCode(200);
    }
